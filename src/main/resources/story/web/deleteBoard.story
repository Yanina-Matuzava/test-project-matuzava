...
When I hover mouse over element located `By.xpath(//*[@aria-label='${boardName} (currently active)'])`
When I click on element located `By.xpath(//*[@aria-label='Board actions menu'])`
When I click on element located by `caseSensitiveText(Close board)`
When I click on element located `By.xpath(//div[@class="atlaskit-portal-container"]//button[@title="Close"])`
When I wait until element located `By.xpath(//*[@data-testid='close-board-delete-board-button'])` appears
When I click on element located `By.xpath(//*[@data-testid='close-board-delete-board-button'])`
When I click on element located `By.xpath(//*[@data-testid='close-board-delete-board-confirm-button'])`
